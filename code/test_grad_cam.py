...
def Inference(FLAGS):
    ...
    test_save_path = f"{snapshot_path}_cbam_aspp_predictions_plot/"
    ...
    save_mode_path = os.path.join(f"/kaggle/input/cect_model_weight/pytorch/default/{FLAGS.labeled_num}", f'{FLAGS.model}_cbam_aspp_best_model.pth')
